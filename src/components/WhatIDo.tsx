  ...
  return (
    <div className="whatIDO" id="whatIDo">
      <div className="what-box">
        <h2 className="title">
          <span className="what-word">WHAT</span>&nbsp;&nbsp;I<span className="do-h2"> DO</span>
        </h2>
      </div>
      <div className="what-box">
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                I develop full-stack web platforms, ML systems, and secure applications with expertise in
                microservices and real-time features.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              <h3>DESIGN</h3>
              <h4>UI/UX & Data Visualization</h4>
              <p>
                I create intuitive interfaces and data visualizations that blend aesthetics with
                functionality for web applications and dashboards.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">GSAP/Three.js</div>
                <div className="what-tags">Plotly/Chart.js</div>
